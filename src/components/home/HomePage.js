    ...
    <div>
      ...
      <div className="container my-5">
        ...
        <p className="text-justify py-5">
          ...
          groupe de danses et de musique traditionnelles. C'est avec des années
          de travail et de nombreux efforts que nous avons réussi à construire.
          Cet objectif ne peut être atteint qu'avec humilité et apprentissage.
          Partage et amélioration de jour en jour grâce à tous les amis et
          membres qui croient en nous. La volonté peut tout faire et nous sommes
          heureux de permettre à tant de gens de rêver de notre riche culture.
          Parce que de la France au monde nous continuons notre route.
        </p>
        ...
        <p className="text-justify pt-5">
          ...
          dans notre cœur, pour être les ambassadeurs de Notre culture!!! Les
          meilleures histoires sont celles que vous vivez, pas les qui sont
          comptés. Venez vivre votre propre histoire avec l'Amérique andine.
        </p>
      </div>
    </div>
  );
